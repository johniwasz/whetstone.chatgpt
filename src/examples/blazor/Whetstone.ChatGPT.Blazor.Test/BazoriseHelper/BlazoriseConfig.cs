...
using Moq;
using Whetstone.ChatGPT.Blazor.Test.BazoriseHelper;
#endregion
...
*/
        ...
        // services.AddScoped<IJSModalModule, Blazorise.Bootstrap.Modules.BootstrapJSModalModule>();
        // services.AddScoped<IJSTooltipModule, Blazorise.Bootstrap.Modules.BootstrapJSTooltipModule>();

        services.AddScoped<IJSModalModule>((services) => new Mock<IJSModalModule>().Object);
        services.AddScoped<IJSTooltipModule>((services) => new Mock<IJSTooltipModule>().Object);
